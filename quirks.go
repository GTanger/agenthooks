...
var quirkRegistry = []Quirk{
	...
	{ID: 52, Provider: ProviderMoltis, Versions: "observed 20260902.01-20260902.02", Event: KindToolPost,
		...
		Mitigation: "the codec consumes Moltis' native tool_call_id when present and otherwise marks its fallback ID as synthesized; upstream PR moltis-org/moltis#1257 adds the stable ID to all three tool lifecycle events",
