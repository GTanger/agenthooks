...
var quirkRegistry = []Quirk{
	...
	{ID: 38, Provider: ProviderCopilot, Versions: "observed 1.0.80", Event: KindOther,
	...
	{ID: 39, Provider: ProviderCopilot, Versions: "all", Event: KindToolPre,
	...
	{ID: 40, Provider: ProviderCopilot, Versions: "all", Event: KindToolPre,
		...
		Reference:  "copilot CLI hooks reference"},
	{ID: 41, Provider: ProviderCopilot, Versions: "all", Event: KindToolPre, Capability: CapDeny,
	...
	{ID: 46, Provider: ProviderVSCodeCopilot, Versions: "VS Code 1.109+ / Copilot Chat 0.38+, Preview", Event: KindOther,
		...
		Mitigation: "demoteVSCodeToCLI rewrites vscode-copilot to copilot when the CLI's own COPILOT_* env is set, so the runtime is resolved before decode and each session gets its own capability row and encoder; decodeCopilot falls through to the Claude codec for the snake_case payload",
