...
<p align="center">
  ...
  <p align="center">Author coding-agent hooks once in Go; run them on Claude Code, Cursor, OpenAI Codex, Gemini CLI, OpenCode, Kimi Code, and GitHub Copilot CLI.</p>
  <p align="center">
    <!-- Go Doc Badge -->
...
| `provider/{claudecode,codex,cursor,gemini,opencode,kimicode,copilot}` | Complete typed native structs with unknown-field capture — the fidelity guarantee |
